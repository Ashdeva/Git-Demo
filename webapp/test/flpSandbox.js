		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nsgitdemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsgitdemoapp-display": {
								"semanticObject": "nsgitdemoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.gitdemoapp",
									"url": sap.ui.require.toUrl("ns/gitdemoapp")
								}
							}
						}
					}
